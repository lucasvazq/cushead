...
class TestArgs(base_tests.BaseTests):
    ...
    def test_invalid_args(self) -> None:
        ...
        self.execute_the_CLI(args=[""], expected_exception="Missing a required argument. Use --config, --default or --help.")

        # Invalid arguments combination.
        self.execute_the_CLI(args=["-c", "-d"], expected_exception="Can't use -c and -d arguments together.")

        # Pass optional argument without a required ones.
        self.execute_the_CLI(args=["-c", "-i"], expected_exception="Can't use -i argument without --default.")

        # Miss the file.
        self.execute_the_CLI(args=["-c"], expected_exception="The path to the config file is missing.")
        self.execute_the_CLI(args=["-d"], expected_exception="The destination path for the default config file is missing.")
...
class TestConfig(base_tests.BaseTests):
    ...
    def test_missing_key(self) -> None:
        ...
        self.execute_the_CLI(args=["-c", str(self.config_file)], expected_exception="Missing key: 'static_url'")
    ...
    def test_invalid_data_type(self) -> None:
        ...
        self.write_config_file()
        self.execute_the_CLI(args=["-c", str(self.config_file)], expected_exception=expected_exception)
    ...
    def test_invalid_key(self) -> None:
        ...
        self.write_config_file()
        self.execute_the_CLI(args=["-c", str(self.config_file)], expected_exception=f"Wrong key 'invalid_key' in {self.config}")
...
class TestReferences(base_tests.BaseTests):
    ...
    def test_inexistent_file(self) -> None:
        ...
        self.execute_the_CLI(args=["-c", str(reference)], expected_exception=expected_exception)
    ...
    def test_config_reference_is_directory(self) -> None:
        ...
        self.execute_the_CLI(args=["-c", str(self.config_folder)], expected_exception=expected_exception)
...
class TestFileCreation(base_tests.BaseTests):
    ...
    def test_file_creation(self) -> None:
        ...
        os.mkdir(reference)
        self.execute_the_CLI(args=["-d", str(reference)])
