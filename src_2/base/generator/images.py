...
class Images:
    ...
    def icons_head_creator(
        ...
        tag_element_list.append(
            ...
            if getattr(brand_config, "tag_name", "")
            else ""
        )
        ...
        tag_element_list.append(
            ...
            if getattr(brand_config, "attribute_color", "")
            else ""
        )
        ...
        tag_element_list.append(
            ...
            if getattr(brand_config, "attribute_content", "")
            else ""
        )
        ...
        tag_element_list.append(
            ...
            if getattr(brand_config, "attribute_property", "")
            else ""
        )
        ...
        tag_element_list.append(
            ...
            if getattr(brand_config, "attribute_name", "")
            else ""
        )
        ...
        tag_element_list.append(
            ...
            if getattr(brand_config, "attribute_rel", "")
            else ""
        )
        ...
        tag_element_list.append(
            ...
            if getattr(brand_config, "attribute_type", "")
            else ""
        )
        ...
        tag_element_list.append(
            ...
            if getattr(brand_config, "sizes_max_min", [])
            else ""
        )
