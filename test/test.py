...
class TestConfigExceptions(unittest.TestCase):
    ...
    def test_miss_config_variable(self):
        with self.assertRaises(Exception) as e:
            Main(INFO, ['-file',
                './test/tests/ConfigExceptions/miss_config_variable/test.txt']).run()
        self.assertRegex(str(e.exception),
    ...
    def test_void_icon_png(self):
        with self.assertRaises(Exception) as e:
            Main(INFO, ['-file', './test/tests/ConfigExceptions/void_icon_png/test.txt']).run()
    ...
    def test_icon_png_doesnt_exists(self):
        with self.assertRaises(Exception) as e:
            Main(INFO, ['-file',
                './test/tests/ConfigExceptions/icon_png_doesnt_exists/test.txt']).run()
        self.assertRegex(str(e.exception),
    ...
    def test_miss_html_file(self):
        with self.assertRaises(Exception) as e:
            Main(INFO, ['-file', './test/tests/ConfigExceptions/miss_html_file/test.txt']).run()
    ...
    def test_void_html_file(self):
        with self.assertRaises(Exception) as e:
            Main(INFO, ['-file', './test/tests/ConfigExceptions/void_html_file/test.txt']).run()
    ...
    def test_html_file_doesnt_exists(self):
        with self.assertRaises(Exception) as e:
            Main(INFO, ['-file',
                './test/tests/ConfigExceptions/html_file_doesnt_exists/test.txt']).run()
        self.assertRegex(str(e.exception),
    ...
    def test_html_file_no_file(self):
        with self.assertRaises(Exception) as e:
            Main(INFO, ['-file', './test/tests/ConfigExceptions/html_file_no_file/test.txt']).run()
        self.assertRegex(str(e.exception),
    ...
    def test_miss_output(self):
        with self.assertRaises(Exception) as e:
            Main(INFO, ['-file', './test/tests/ConfigExceptions/miss_output/test.txt']).run()
    ...
    def test_output_doesnt_exists(self):
        with self.assertRaises(Exception) as e:
            Main(INFO, ['-file',
                './test/tests/ConfigExceptions/output_doesnt_exists/test.txt']).run()
        self.assertRegex(str(e.exception),
    ...
    def test_miss_static_url(self):
        with self.assertRaises(Exception) as e:
            Main(INFO, ['-file', './test/tests/ConfigExceptions/miss_static_url/test.txt']).run()
...
class TestSuccess(unittest.TestCase):
    ...
    def test_void_config():
        Main(INFO, ['-file', './test/tests/Success/void_config/test.txt']).run()

    # Void *.html file
    @staticmethod
    def test_void_html_FILE():
        Main(INFO, ['-file', './test/tests/Success/void_html_FILE/test.txt']).run()

    # -preset
    @staticmethod
    def test_preset():
        Main(INFO, ['-preset', './test/tests/Success/test.txt']).run()
...
class TestSpecialConfigSuccess(unittest.TestCase):
    ...
    @staticmethod
    def test_miss_1():
        Main(INFO, ['-file', './test/tests/SpecialConfigSuccess/miss_1/test.txt']).run()

    # Miss 'title', 'description', 'dir', 'start_url', 'orientation', 'color',
    # 'language', 'scope', 'display', 'platform' and 'applications'
    @staticmethod
    def test_miss_2():
        Main(INFO, ['-file', './test/tests/SpecialConfigSuccess/miss_2/test.txt']).run()

    # Miss 'url'
    @staticmethod
    def test_miss_url():
        Main(INFO, ['-file', './test/tests/SpecialConfigSuccess/miss_url/test.txt']).run()

    # Miss 'sitemap'
    @staticmethod
    def test_miss_sitemap():
        Main(INFO, ['-file', './test/tests/SpecialConfigSuccess/miss_sitemap/test.txt']).run()
